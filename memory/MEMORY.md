...
- [Deploy allowlist pitfall](deploy-allowlist-pitfall.md) — deploy.sh rsync loop is a hardcoded allowlist; new top-level files must be added or they silently never deploy
